...
if __name__ == "__main__":
    ...
    # Flag to track if the Object Detector window is open
    ...
    while True:
        if ser.in_waiting > 0:
            ...
            if line == "cam_detected":
                # Remove the previous captured image
                ...
                if ret:
                    ...
                    # Automatically close the Object Detector window
                    cv2.waitKey(5000)  # Wait for 5 seconds (5000 milliseconds)

                    # Close the Object Detector window
