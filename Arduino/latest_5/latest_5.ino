...
const int cam_us_max_distance = 30;
...
void loop() {
  ...
  if (us_cam_detect_interval.update() && cam_us.convert_cm(cam_us.ping_median(5)) <= cam_us_max_distance && busy_camera == false && busy_water_trash == false && rpi_state == true)
  {
    busy_camera = true;  
    detected();
  }  
